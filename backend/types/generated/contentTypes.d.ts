...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_snapshot: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shipping_details: Schema.Attribute.JSON;
    stato: Schema.Attribute.Enumeration<
      ['In Attesa', 'Pagato', 'Completato', 'Spedito']
    >;
    stripe_id: Schema.Attribute.String;
    total_paid: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nome_variante: Schema.Attribute.String;
    opzioni: Schema.Attribute.JSON;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galleria: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    immagine: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    is_featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    is_service: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    note_indirizzo: Schema.Attribute.String;
